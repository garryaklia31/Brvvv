...
tok = "6348260945:AAFEz17b7NiGad3FrNjhEC4SMou56nfyR80"
...
def mess(message):
	...
	if '/status' in text:
		bot.reply_to(message,"<strong>Online => ✅\nBot: @garryplays ♻️</strong>",parse_mode="html")
...
To use <a href="https://telegram.dog/garryplays">Brav</a> in your group, you must set it as admin.</strong>""",parse_mode="html",reply_markup=key)
